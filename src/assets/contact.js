                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control border-blue" id="name" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control border-blue" id="email" />
                                </div>
                            </div>
                            <div class="col-6 text-right">
                                <button type="submit" class="">Submit <i class="far fa-envelope"></i></button>
                            </div>
                        </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control border-blue" id="exampleFormControlTextarea1" rows="9"></textarea>
                                    </div>
                                </div>
                        </div>
                     </form>
